...
<body>
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand">Welcome ${loggedInUser.first_name}</a>
			</div>
			
			<ul class="nav navbar-top-links navbar-right">
				<p style="margin-top: 6px; margin-right: 1cm;">

					<a href="<c:url value="login.html" />"
						class="btn btn-danger square-btn-adjust"
						class="nav navbar-top-links navbar-right" class="icon-bar">Log In</a>
				</p>
			</ul>

			<%--			<!-- /.navbar-header -->
			<p class="nav navbar-top-links navbar-right" class="icon-bar">
				<button href="list.html" type="button" class="btn btn-danger">Log
					out!</button>		
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
                   ...
                   --%>
						<li><a href="<c:url value="/dashboard.html"/>"><i class="fa fa-dashboard fa-fw"></i>
								Dashboard</a></li>
						<%--     <li>
                    ...
                    --%>
						<li><a href="<c:url value="#"/>"><i class="fa fa-table fa-fw"></i>Departments</a>
						
						</li>
						<li><a href="#"><i class="fa fa-edit fa-fw"></i>Applications</a>
						</li>
						<%-- <li>
	...
	<%-- 		<div class="panel panel-default">
				...
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							...
							<td> <a href="viewDepartment.html?id=${department.id}">View Details</a>
				</td>
						</tr>
				...
				&nbsp; <a href="<c:url value="addDepartment.html" />"
					...
					class="nav navbar-top-links navbar-right" class="icon-bar">Add Department</a>
