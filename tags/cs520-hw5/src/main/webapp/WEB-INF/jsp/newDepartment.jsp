...
<body>
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				&nbsp; <a href="<c:url value="logout.html" />"
					...
					class="nav navbar-top-links navbar-right" class="icon-bar">Logout</a>
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
                   ...
                   --%>
                    ...
                    --%>
						<li><a href="tables.html"><i class="fa fa-table fa-fw"></i>Departments</a>
						</li>
						<li><a href="forms.html"><i class="fa fa-edit fa-fw"></i>Applications</a>
						</li>
						<%-- <li>
		...
		<div id="page-wrapper">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="panel panel-red">
						...
						<a href="<c:url value="departments.html"/>">
							<div class="panel-footer">
								<span class="pull-left">View Details</span> <span
									class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
								<div class="clearfix"></div>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-bar-chart-o fa-fw"></i> ${department.name}
					Department
				</div>
